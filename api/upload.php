...
function uploadImage($file) {
    ...
    if ($file['error'] === UPLOAD_ERR_OK) {
        ...
        curl_setopt($ch, CURLOPT_POSTFIELDS, http_build_query(['key' => $api_key, 'image' => $image]));
        ...
        $err = curl_error($ch);
        curl_close($ch);
        if ($err) return 'https://dummyimage.com/400x400/dc3545/ffffff.png&text=Error+Koneksi';
